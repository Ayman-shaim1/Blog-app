          ...
          <Row>
            <Col xl={6} lg={6} md={6} sm={12}>
              <Card bg="info" text="light">
                <Card.Body>
                  <h2 style={{ color: "#fff" }}>
                    <i className="fas fa-user-friends"></i> {nbrRegistred}{" "}
                    Registred users
                  </h2>
                </Card.Body>
              </Card>
              ...
              <Card bg="secondary" className="m-2">
                <Card.Body>
                  ...
                  <div className=" mt-3  d-flex justify-content-center">
                    <h5 className="m-2">
                      {users.filter((u) => u.providerId === undefined).length}{" "}
                      users
                    </h5>
                    <h3>|</h3>
                    <h5 className="m-2">
                      {nbrEmailPasswordVisits ? nbrEmailPasswordVisits : 0}{" "}
                      visits
                    </h5>
                  </div>
                </Card.Body>
                ...
                <Card.Body>
                  ...
                  <div className=" mt-3 d-flex justify-content-center">
                    <h5 className="m-2" style={{ color: "#fff" }}>
                      {
                        users.filter((u) => u.providerId === "google.com")
                          .length
                      }{" "}
                      users
                    </h5>
              ...
              <Card bg="info" className="m-2" text="light">
                <Card.Body>
                  ...
                  <div className=" mt-3 d-flex justify-content-center">
                    <h5 className="m-2" style={{ color: "#fff" }}>
                      {
                        users.filter((u) => u.providerId === "facebook.com")
                          .length
                      }{" "}
                      users
                    </h5>
